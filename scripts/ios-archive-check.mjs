...
const checks=[
  [/PRODUCT_BUNDLE_IDENTIFIER = se\.vaderkompassen\.app/,"Bundle ID"],[/MARKETING_VERSION = 15\.0\.6/,"Marketing version"],[/CURRENT_PROJECT_VERSION = 11/,"buildnummer"],[/IPHONEOS_DEPLOYMENT_TARGET = 15\.0/,"deployment target"],[/CODE_SIGN_STYLE = Automatic/,"automatisk signing"]
];
