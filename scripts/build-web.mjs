...
const files=["index.html","styles.css","place-registry.js","app.js","auth.js","admin.js","cloud-request.js","refresh-controller.js","config.js","environment.js","native-platform.js","ads-config.js","ads-provider.js","fishing-score.js","navigation.js","subscription-providers.js","manifest.webmanifest","sw.js","icon-180.png","icon-192.png","icon-512.png"];
...
const publicConfig={name,debug:name==="development",apiBaseUrl:process.env.VK_PUBLIC_WORKER_URL||undefined,supabaseUrl:process.env.VK_PUBLIC_SUPABASE_URL||undefined,supabaseAnonKey:process.env.VK_PUBLIC_SUPABASE_ANON_KEY||undefined,subscriptionMode:process.env.VK_SUBSCRIPTION_MODE||(name==="development"?"manual_test":"disabled"),socialAuthEnabled:name!=="production"&&process.env.VK_SOCIAL_AUTH_ENABLED==="true",adsMode,adsEnabled:process.env.VK_ADS_ENABLED?process.env.VK_ADS_ENABLED==="true":name==="staging",adsConsentDebugGeography:process.env.VK_ADS_CONSENT_DEBUG_GEOGRAPHY||undefined,ads:{ios:adPlatform("IOS"),android:adPlatform("ANDROID")}};
