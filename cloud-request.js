(function(root){
  ...
  function createRequestKey(baseUrl,{activity="general",regions=[],areas=[],days="1",access="free"}={}){
    const params=new URLSearchParams();
    params.set("activity",String(activity||"general").trim()||"general");
    params.set("days",days==="all"?"all":"1");
    params.set("access",access==="premium"?"premium":"free");
