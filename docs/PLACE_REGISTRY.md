...
Importen innehåller 300 svenska, 100 norska och 100 danska Premiumkandidater. I denna release är 47 koordinat-, områdes- och kategoriverifierade kandidater aktiverade. 197 väntar på områdesgranskning, 224 på kategorigranskning och 32 på dubblettgranskning. Inga osäkra poster aktiveras automatiskt.
