...
5. Kör `npm run deploy:production`. Kommandot deployar root-entrypointen och stoppar om publik Worker-version inte är `14.4.2`.
6. Kontrollera att webbplatsen visar `Väderkompassen v14.4.2` i sidfoten.
