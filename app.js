...
const diagnostics={version:"13.1.0",mode:"local",lastLoad:null,sources:[]};
const WEATHER_CACHE_KEY="vk-weather-cache-v13.1.0";
const POINT_CACHE_KEY="vk-point-cache-v13.1.0";
...
if("serviceWorker"in navigator)window.addEventListener("load",async()=>{
  const reg=await navigator.serviceWorker.register(`sw.js?v=13.1.0`);
  reg.update();
